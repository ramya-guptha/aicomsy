...
class NcrResponse(models.Model):
    ...
    reviewed_and_approved_by = fields.Char(string='Reviewed & Approved by')
    ...
    prepared_by_title = fields.Char(string='Title', help='Maximum 30 character only')
    reviewed_by_title = fields.Char(string='Title', help='Maximum 30 character only')
